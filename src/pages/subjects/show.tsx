...
const SubjectsShow = () => {
    ...
    // Early guard: prevent API calls with empty subjectId
    if (!subjectId) {
        return (
    ...
    const classColumns = useMemo<ColumnDef<SubjectClass>[]>(() => [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                if (!teacher) return <span className="text-muted-foreground">Unassigned</span>;
                return (
    ...
    const teachersTable = useTable<SubjectUser>({
        ...
        refineCoreProps: {
            ...
            pagination: { pageSize: 10, mode: "server" },
            filters: { permanent: [{ field: "role", operator: "eq", value: "teacher" }] },
        },
    });
